	...
	jQuery.fn.contactable = function(options) {
		...
		return this.each(function() {
			...
			if(options.dropdownTitle) {
				dropdown += '<p class="contactable-row"><label class="contactable-label" for="contactable-dropdown">'+options.dropdownTitle+' </label><br /><select name="dropdown" id="contactable-dropdown" class="contactable-dropdown">';
			...
			*/
			...
			jQuery(this).html('<div id="contactable-inner"></div><form id="contactable-contactForm" method="" action=""><div id="contactable-loading"></div><div id="contactable-callback"></div><div class="contactable-holder"><p class="contactable-row"><label class="contactable-label" for="contactable-name">'+options.name+'<span class="contactable-green"> * </span></label><br /><input id="contactable-name" class="contactable-contact contactable-validate" name="name" value="'+options.name_val+'" /></p><p class="contactable-row"><label class="contactable-label" for="contactable-email">'+options.email+' <span class="contactable-green"> * </span></label><br /><input id="contactable-email" class="contactable-contact contactable-validate" name="email" value="'+options.email_val+'"/></p>'+dropdown+'<p class="contactable-row"><label class="contactable-label" for="contactable-message">'+options.message+' <span class="contactable-green"> * </span></label><br /><textarea id="contactable-message" name="message" class="contactable-message contactable-validate" rows="6" cols="30" ></textarea></p><p class="contactable-row"><input class="btn btn-primary" type="submit" value="'+options.submit+'"/></p><p class="contactable-disclaimer">'+options.disclaimer+'</p></div></form>');
			
			// Toggle the form visibility
			// my_contactable_state - global variable, defined before contactable general handler call
            jQuery('#contactable-inner').click(function() {
                if (my_contactable_state == 0) { // hidden now, show
